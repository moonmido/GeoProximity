...
* The original package name 'com.GeoProximity.es-worker-service' is invalid and this project uses 'com.GeoProximity.es_worker_service' instead.
...
* [Spring Data Elasticsearch](https://docs.spring.io/spring-boot/4.0.0/reference/data/nosql.html#data.nosql.elasticsearch)
